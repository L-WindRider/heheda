        ...
        f = {
            ...
            controlNav: {
                ...
                setupPaging: function() {
                    ...
                    if (1 < a.pagingCount) for (var n = 0; n < a.pagingCount; n++) g = "thumbnails" === c.controlNav ? '<img src="' + a.slides.eq(n).attr("data-thumb") + '"/>': "<a>"+"<i>"+"</i>"+ "</a>",/*"<a>" + b +"<i>"+"</i>"+ "</a>"这里的b是指轮播的个数1.2.3.4.5*/
